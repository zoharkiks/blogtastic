  ...
  return (
    <div className="comments font-montserrat relative">
        ...
        {!login ? (
                ...
                {registerVisible ? (
                  <div className="bg-clip-padding backdrop-filter backdrop-blur-[4px] bg-opacity-[25%] border border-gray-200 bg-white h-full flex flex-col w-full justify-center  items-center fixed top-0 left-0 z-[1]">
                    <motion.div
                      ...
                      animate="visible"
                      exit="hidden"
                      className="bg-[#F26419] rounded-[10px]  w-[280px] h-[360px] relative z-[1] flex flex-col  items-center sm:w-[340px] sm:h-[430px] lg:w-[80%] lg:grid lg:grid-cols-2"
                    >
                      <CloseIcon
                        onClick={viewSignUp}
                        className="absolute top-2 right-[10px] text-[#F1DAC4] sm:!text-[2rem] "
          ...
          <AnimatePresence>
            <motion.div
              ...
              animate="visible"
              exit="hidden"
              className="bg-[#BA274A] rounded-[10px] px-6 py-[18px] flex flex-col mt-5"
            >
      ...
      {comments.length > 0 ? (
        ...
        <span className="px-6 my-4 font-bold text-xl sm:text-2xl lg:text-3xl">
