...
const Modal = () => {
  return (
    <div className="callToAction">  
      <div className="bg-white   h-70 flex flex-col items-center space-y-6 p-4 font-montserrat sm:h-[22rem] ">
        <h1 className='text-2xl p-2 sm:text-4xl'>Welcome to Blogtastic</h1>
        <div className=" border-4 border-gray-300 grid grid-cols-2 p-2 gap-2 ">
          <img
