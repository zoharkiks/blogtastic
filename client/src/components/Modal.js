  ...
  return (
    <div className="callToAction">
      <div
        ...
        className="bg-cover bg-center h-70 flex flex-col items-center space-y-6 p-4 font-montserrat sm:h-[22rem] lg:grid lg:grid-cols-2 lg:px-10 "
      >
        <h1 className="text-2xl p-2 sm:text-4xl xl:text-[4rem] xl:w-screen xl:h-20 ">Welcome to Blogtastic</h1>
