  ...
  return (
    <div className="article text-[#24272B] bg-[#FAF2EA] font-montserrat  ">
      {loading ? (
        ...
        {
          categories &&  categories[1] ? <span className="bg-[#F26419] text-white font-semibold text-left rounded-[10px] mt-[10px]  max-h-8 w px-2 sm:text-xl lg:text-[1.5rem] lg:px-4]">
        ...
        <span className='text-lg mt-2 lg:text-xl'>{estimateTime(`${articleContent}`)} </span>


          <div className="  w-full mt-4 md:px-[5rem] lg:px-[7rem] ">
            <img
          ...
          <div className="flex items-center justify-space-between space-x-16 mt-6">
            <div className="flex flex-col justify-evenly items-center">
              <Avatar className='lg:!h-16 lg:!w-16'>{firstLetter(`${author}`)}</Avatar>
          ...
          {/* Share Icons */}
            <div className=" flex justify-evenly space-x-4 mt-5 border-b-2 border-[#24272B] pb-3 lg:hidden">
              <FacebookShareButton
