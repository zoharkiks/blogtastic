  ...
  return (
    <div className="aboutMe">
      <div className="bg-[#9448BC] text-[#F1DAC4] flex flex-col items-center py-4 px-5 font-montserrat space-y-5">
        <div className=" rounded-full h-36 w-36 shadow-2xl flex items-center justify-center filter grayscale overflow-hidden sm:h-48 sm:w-48 ">
          <img
        ...
        <p className="leading-loose font-medium text-xl text-left sm:text-[1.5rem] ">
